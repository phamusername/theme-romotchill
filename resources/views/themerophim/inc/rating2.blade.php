<div class="box-rating" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
    <div class="flex" id="star" data-score="{{ $currentMovie->getRatingStar() }}" style="cursor: pointer; width:15px; height:15px"></div>
    <div>
...
<script src="/themes/rophim/rating2/jquery.raty.js"></script>
<script>
    var rated = false;
    $('#star').raty({
        number: 10,
        starHalf: '/themes/rophim/rating2/images/star-half.png',
        starOff: '/themes/rophim/rating2/images/star-off.png',
        starOn: '/themes/rophim/rating2/images/star-on.png',
