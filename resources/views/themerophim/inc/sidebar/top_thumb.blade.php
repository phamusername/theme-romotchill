<div class="pt-6">
    <div>
        <section class="text-gray-600 body-font">
            <div>
                <div class="flex flex-col w-full mb-2"><span class="uppercase font-medium text-gray-200 text-md border-b border-zinc-800 w-full block pb-2 mb-2">{{ $top['label'] }}</span></div>
                <div class="-m-2">
                            ...
                            <div class="h-full flex border-zinc-800 border p-2 rounded-sm gap-2">
                                ...
                                <div class="w-3/5 truncate">
                                    ...
                                    <div class="flex items-center pt-2">
                                        <svg
                                            class="w-4 h-4 text-zinc-400 me-1"
                                            aria-hidden="true"
